...
st.header(":red[Price VS Features]")
...
feature=st.selectbox(
    "Select Feature to get the Relation",
    (data.columns))
...
fig.update_layout(title="Average, Minimum and Maximum Price of Laptop by {}".format(feature))
