...
#Page Headingpip install -U scikit-learn
st.header(":red[Laptop Price Prediction using Machine Learning]:pencil:")
...
if st.button('Predict'):
    ...
    st.subheader(":blue[Laptop Price of Selected Features :] :green[{}]".format("₹"+str(price)))
else:
    pass